                    ...
                    ## On the asteroids
                        ...
                        for aste in asteroides:
                            if me[ship]['Centre'] == asteroides[aste]['Position']:
                                if me[ship]['Capacity'] == me[ship]['Tonnage'] or asteroides[aste]['Ore'] <= 0:  
                                    order.append('%s:release'%ship)
...
def start(card_txt, player_A,player_id):
    ...
    connection = remote_play.connect_to_player(player_id, '138.48.160.131', True)
...
start('/home/users/100/cverhoev/Downloads/gameboard_2_gr_17.mw', 2,1)
